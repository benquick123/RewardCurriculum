...
for task in ["Reach", "Slide", "Push", "PickAndPlace", "MultiRewardPickAndPlace", "MultiRewardPickAndPlaceSphere", "MultiRewardPickAndPlaceObstacle", "Stack", "MultiRewardStack", "Flip"]:
    for reward_type in ["sparse", "dense"]:
        for control_type in ["ee", "joints"]:
            ...
            register(
                ...
                max_episode_steps=50 if task.endswith("Stack") else 50,
            )
